...
from image_utils import delete_profile_image, process_profile_image #upload_profile_image (for s3)
from schemas import (
...
async def delete_user(
    ...
    if old_filename:
        #await delete_profile_image(old_filename) #(await this cause this funtion is now async (image_utils.py))
        delete_profile_image(old_filename) #(for local save)
...
async def upload_profile_picture(
    ...
    try:
        #(did processed bytes ,for S3, cause now we're receiving tuple)
